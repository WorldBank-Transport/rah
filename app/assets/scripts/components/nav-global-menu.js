    ...
    return (
      <div className='nav__block nav__block--global'>
        <ul className='nav-global-menu'>
          <li><NavLink to='/' exact title='View all projects' className='nav-global-menu__link' activeClassName='nav-global-menu__link--active'><span>Projects</span></NavLink></li>
